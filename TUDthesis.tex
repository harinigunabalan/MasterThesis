...
\section*{\begin{center}
	...
	\end{center}}
		...
		\par {This Thesis is a collaboration with SAP research, Darmstadt, as a part of Cloudwave project, an EU-funded research project that is enabling a next generation of cloud infrastructure operations and agile development for their hosted applications.}\\
		\begin{flushleft}
			\textit{Supervisors at SAP Research and other Cloudwave partners: \newline \newline
